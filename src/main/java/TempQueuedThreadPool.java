...
public class TempQueuedThreadPool extends AbstractLifeCycle implements Serializable, ThreadPool
{
    ...
    /* Construct
     */
    public TempQueuedThreadPool(int maxThreads)
    {
        this();
